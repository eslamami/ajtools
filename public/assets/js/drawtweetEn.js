  ...
  var bbg = new Image ;
      bbg.src = "/assets/images/footer_en.png";
  ...
  var ctx = canvas.getContext("2d");
    ...
    var count_ico_marg = 8 ;
      ...
      // draw the circle around user profile picture
          circleMask(Pimg,x-150 ,80,150,150,70);

           if (Vuser == true ){

              ctx.font = '30pt ArHelvet';
              var userlength = ctx.measureText(tusrname).width;
              var xusr = canvas.width-270 ;
      ...
      //wrapText(context, text, x, y, maxWidth, lineHeight);
          ...
          context.fillStyle = '#333';
           ...
           context.fillText(tusrname, xusr , 150);
               ...
               context.font = '20pt ArHelvet';
               context.fillStyle = '#a5a5a5';
           context.fillText('@'+tsusrname, xusr , 190);
  }
